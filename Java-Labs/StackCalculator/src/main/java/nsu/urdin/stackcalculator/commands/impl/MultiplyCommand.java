...
public class MultiplyCommand extends Command {
    private static final Logger LOGGER = LogManager.getLogger(MultiplyCommand.class);

    public MultiplyCommand(CommandParser.Data commandData) {
    ...
    public void exec(CalcContext context) throws CommandExecuteException {
        ...
        LOGGER.debug("Executed multiply command: {} * {} = {}", o1, o2, result);
    }
}
